...
; rdi -- sepia matrix address
; rsi -- pixels buffer address
; rdx -- buffer size
sepia_asm:
; save calee-saved regs
    mov [rsp-8], r12
    mov [rsp-16], r13
    mov [rsp-24], r14
    mov [rsp-32], r15
  ...
  .processing_loop:
    ...
    ; Add the result of multiplication
    addps xmm3, xmm4
    addps xmm3, xmm5
    ...
    movq r12, xmm3 ; r1 r2 r3 r4
    movq r11, xmm4 ; g1 g2 g3 g4
    movq r10, xmm5 ; b1 b2 b3 b4

    ; Pack bytes to store them back in pixels array
    mov r13, r10 ; r1
    mov r14, r11 ; g1
    mov r15, r12 ; b1
    mov rax, r10 ; r2
